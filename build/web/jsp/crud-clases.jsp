<%-- 
    Document   : crud-sesiones
    Created on : 5 nov 2023, 14:33:18
    Author     : serna
--%>
                ...
                <table border="1">
                    ...
                    <tbody>
                        <c:forEach var = "dato" items = "${datos}">
                            <tr>
                                <td>${dato.getID_CLASE()}</td>
                                <td>${dato.getLINK_GRABACION()}</td>
                                <td>${dato.getCLASE_DESCRIPCION()}</td>
                                <td>
                                    <form action = "/Siic/ControladorClases" method="POST">
                                        <input type="hidden" name="id" value="${dato.getID_CLASE()}"> 
